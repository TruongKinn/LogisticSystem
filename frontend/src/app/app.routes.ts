...
export const routes: Routes = [
    ...
    { path: 'drivers/:id', loadComponent: () => import('./driver/driver-detail/driver-detail').then(m => m.DriverDetail), canActivate: [authGuard] },
    { path: 'vehicles', loadComponent: () => import('./vehicle/vehicle-list/vehicle-list').then(m => m.VehicleList), canActivate: [authGuard] },
    { path: 'vehicles/:id', loadComponent: () => import('./vehicle/vehicle-detail/vehicle-detail').then(m => m.VehicleDetail), canActivate: [authGuard] },
