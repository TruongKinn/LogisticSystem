package vn.logistic.logisticsservice.exception;
...
import vn.logistic.logisticsservice.controller.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleDownstream(DownstreamServiceException exception, HttpServletRequest request) {
        return buildErrorResponse(HttpStatus.BAD_GATEWAY, "DOWNSTREAM_SERVICE_ERROR", exception.getMessage(), request.getRequestURI());
    }
